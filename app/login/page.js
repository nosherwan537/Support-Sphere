...
const Login = () => {
    return (
        <div className="container mx-auto py-14 ">
            <div className="flex flex-col items-center min-h-screen p-10 gap-2">
                <h1 className="text-white montserrat-regular relative bottom-5">
                    LOGIN AND BECOME PART OF COMMUNITY
                </h1>
                <button className="flex items-center w-72 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg
